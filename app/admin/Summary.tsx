...
const Summary: React.FC<SummaryProps> = ({ orders, products, users }) => {
  ...
  useEffect(() => {
    setSummaryData((prev) => {
      ...
      tmpData.sale.digit = totalSale;
      tmpData.orders.digit = orders.length;
      tmpData.paidOrders.digit = paidOrders.length;
      tmpData.unpaidOrders.digit = unpaidOrders.length;
      tmpData.products.digit = products.length;
      tmpData.users.digit = users.length;
